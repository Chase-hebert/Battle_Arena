...
namespace Battle_Arema
{
    internal class Game
    {
        ...
        private void Start()
        {
            player = new Character(name: , enemyName: "", maxHealth: 100, attackPower: 10, defensePower: 5);
            enemy = new Character(name:  , enemyName: "Blimbo", maxHealth: 100, attackPower: 8, defensePower: 3);
            player.PrintStats();
            Console.WriteLine();
            enemy.PrintStats();
